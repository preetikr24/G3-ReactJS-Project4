...
import { Badge, Button, Card, Container, NavItem, OverlayTrigger, Toast, Tooltip } from "react-bootstrap";
...
import { getIndianMovies, getIndianMoviesByTitle } from "../../services/topRatedIndian";
...
const IndianSearch = () => {
    ...
    const findByTitle = () => {
        ...
        console.log(getIndianMoviesByTitle(title), "titledata")
        // console.log(data,"data");
        const data = getIndianMoviesByTitle(title)
            .then((response) => {
                setData(response)
                                ...
                                <div>
                                    <Card.Title className="d-flex justify-content-between" >
                                        ...
                                        <div>
                                            ...
                                            <Link to={`/top-rated-india/${item.id}`} className="btn btn-dark btn-sm"
