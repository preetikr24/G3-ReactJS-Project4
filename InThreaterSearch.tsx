...
const InThreaterSearch = () => {
    ...
    const findByTitle = () => {
        ...
        console.log(getMoviesByTitle(title), "titledata")
        // console.log(data,"data");
        const data = getMoviesByTitle(title)
            .then((response) => {
                setData(response)
                            ...
                            <Card.Body>
                                <div>
                                    <Card.Title className="d-flex justify-content-between" >
                                        ...
                                        <div>
                                            <Link to={`/movies-in-theaters/${item.id}`} className="btn btn-dark btn-sm"
...
export default InThreaterSearch;