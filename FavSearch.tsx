...
import { getFavMovies, getFavMoviesByTitle } from "../../services/favourite";
...
const FavSearch = () => {
    ...
    const findByTitle = () => {
        ...
        console.log(getFavMoviesByTitle(title), "titledata")
        // console.log(data,"data");
        const data = getFavMoviesByTitle(title)
            .then((response) => {
                setData(response)
                            ...
                            <Card.Body>
                                <div>
                                    <Card.Title className="d-flex justify-content-between" >
                                        ...
                                        <div>
                                            <Link to={`/favourite/${item.id}`} className="btn btn-dark btn-sm"
