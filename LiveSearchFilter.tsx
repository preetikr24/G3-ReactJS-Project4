...
const LiveSearch = () => {
    ...
    const findByTitle = () => {
        ...
        console.log(getComingMoviesByTitle(title), "titledata")
        // console.log(data,"data");
        const data = getComingMoviesByTitle(title)
            .then((response) => {
                setData(response)
    ...
    return (
        <div className="input-group mb-3 justify-content-end" >
            ...
            <Badge bg="secondary">Search with Perfect name(case Sensetive)</Badge>
                <input type="text" placeholder="search full name " value={title} onChange={handleInputChange} />
            </div>
                            ...
                            <Card.Body>
                                <div>
                                    <Card.Title className="d-flex justify-content-between" >
                                        ...
                                        <div>
                                            <Link to={`/movies-coming/${item.id}`} className="btn btn-dark btn-sm"
